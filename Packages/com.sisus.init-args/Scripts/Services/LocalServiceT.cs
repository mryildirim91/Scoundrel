...
namespace Sisus.Init
{
	...
	internal static class LocalService<TService>
	{
		...
		{
			#if DEV_MODE
			Debug.Assert(client is not null, "LocalService<T>.IsServiceFor called with null client.");
			Debug.Assert(test is not null, "LocalService<T>.IsServiceFor called with null object to test.");
			#endif
		...
		{
			#if DEV_MODE
			Debug.Assert(test is not null, "LocalService<T>.IsService called with null object to test.");
			#endif
